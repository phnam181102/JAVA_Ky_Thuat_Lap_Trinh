...
public class Cau02 {
    ...
    public static void main(String[] args) {
        ...
        nhap(a, n);
        xuat(a, n);
        System.out.println("\n\nCo " + dem(a, n) + " phan tu chia het cho 5 ma khong chia het cho 3");
        System.out.println("\nGia tri lon nhat trong mang A la: " + max(a, n));
        check(a, n);
        tach(a, n);
    }
    ...
    // Đếm số phần tử có giá trị chia hết cho 5 mà không chia hết cho 3
